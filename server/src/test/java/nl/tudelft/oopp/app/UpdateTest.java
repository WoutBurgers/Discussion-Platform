...
class UpdateTest {
    ...
    void setup() {
        ...
        q1.setAnswer("Server Answer");
        q2.setAnswer("Not Server Answer");
    ...
    void testToStringTest() {
        assertEquals("Update<addQuestions, [Question<Student: User<id: 50, username: student>, "
                + "I want to test the app, 0, Server Answer>, "
                + "Question<Student: User<id: 60, username: notStudent>, "
                + "I don't want to test the app, 0, Not Server Answer>]>", u1.toString());
    }
    ...
    void setUpdatedNumberOfStudentsTest() {
        u1.setUpdatedNumberOfStudents(53);
        assertEquals(53, u1.getUpdatedNumberOfStudents());
    }

    @Test
    void setUpdatedTooSlowVotes() {
        u1.setUpdatedTooSlowVotes(17);
        assertEquals(17, u1.getUpdatedTooSlowVotes());
    }

    @Test
    void setUpdatedTooFastVotesTest() {
        u1.setUpdatedTooFastVotes(21);
        assertEquals(21, u1.getUpdatedTooFastVotes());
    }
